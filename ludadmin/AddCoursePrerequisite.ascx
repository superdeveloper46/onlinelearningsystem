    ...
    <div class="col-sm-6">
        <div class="margin-left-30">
            ...
            <div class="font-size-13">
                <asp:GridView CssClass="table table-bordered grid-table" ID="GridViewCoursePrerequisite" runat="server" AutoGenerateColumns="False" DataKeyNames="CorequisiteCourseId" OnRowDataBound="GridViewCoursePrerequisite_RowDataBound" OnRowDeleting="GridViewCoursePrerequisite_RowDeleting" OnRowCancelingEdit="GridViewCoursePrerequisite_RowCancelingEdit" OnRowEditing="GridViewCoursePrerequisite_RowEditing" OnRowUpdating="GridViewCoursePrerequisite_RowUpdating">
                    <Columns>
