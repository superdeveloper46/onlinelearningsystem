...
public class SqlCompiler : CloudCompiler
{
    ...
    public override ExecutionResult Run(RunInfo runInfo, CompilerInfo compilerInfo)
    {
        ...
        string connectionString = ConfigurationsHelper.GetLudsampleDb();
    ...
    public override ExecutionResult RunCodeForValidation(LMS.Common.Infos.RunInfo runInfo, CompilerInfo compilerInfo)
    {
