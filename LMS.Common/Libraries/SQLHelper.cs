...
namespace LMSLibrary
{
    public static class SQLHelper
    {
        ...
        {
            string connectionInfo = DefaultConnectionString;
        ...
        public static int RunSqlUpdateReturnAffectedRows(string sqlQuery)
        {
            string connectionInfo = DefaultConnectionString;
            if (System.Configuration.ConfigurationManager.ConnectionStrings["MaterialEntities1"] != null)
            {
            ...
            return RunSqlUpdateReturnAffectedRows(connectionInfo, sqlQuery);
        }
        ...
        public static int RunSqlUpdateReturnAffectedRows(string connectionInfo, string sqlQuery)
        {
            int result = 0;
            try
            {
